...
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthenticatorWatcherEvent);
}
...
$AuthenticatorWatcherEventCopyWith(AuthenticatorWatcherEvent _, $Res Function(AuthenticatorWatcherEvent) __);
}
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthenticatorWatcherState);
}
...
$AuthenticatorWatcherStateCopyWith(AuthenticatorWatcherState _, $Res Function(AuthenticatorWatcherState) __);
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Initial value)?  initial,TResult Function( _Authenticating value)?  authenticating,TResult Function( _Authenticated value)?  authenticated,TResult Function( _Unauthenticated value)?  unauthenticated,TResult Function( _IsFirstTime value)?  isFirstTime,required TResult orElse(),}){
final _that = this;
switch (_that) {
...
return unauthenticated(_that);case _IsFirstTime() when isFirstTime != null:
return isFirstTime(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Initial value)  initial,required TResult Function( _Authenticating value)  authenticating,required TResult Function( _Authenticated value)  authenticated,required TResult Function( _Unauthenticated value)  unauthenticated,required TResult Function( _IsFirstTime value)  isFirstTime,}){
final _that = this;
switch (_that) {
case _Initial():
...
return unauthenticated(_that);case _IsFirstTime():
return isFirstTime(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Initial value)?  initial,TResult? Function( _Authenticating value)?  authenticating,TResult? Function( _Authenticated value)?  authenticated,TResult? Function( _Unauthenticated value)?  unauthenticated,TResult? Function( _IsFirstTime value)?  isFirstTime,}){
final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial(_that);case _Authenticating() when authenticating != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  authenticating,TResult Function( UserModel? user)?  authenticated,TResult Function()?  unauthenticated,TResult Function()?  isFirstTime,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
...
return unauthenticated();case _IsFirstTime() when isFirstTime != null:
return isFirstTime();case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  authenticating,required TResult Function( UserModel? user)  authenticated,required TResult Function()  unauthenticated,required TResult Function()  isFirstTime,}) {final _that = this;
switch (_that) {
case _Initial():
...
return unauthenticated();case _IsFirstTime():
return isFirstTime();case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  authenticating,TResult? Function( UserModel? user)?  authenticated,TResult? Function()?  unauthenticated,TResult? Function()?  isFirstTime,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Authenticating() when authenticating != null:
return authenticating();case _Authenticated() when authenticated != null:
...
@override
String toString() {
    return 'AuthenticatorWatcherState.authenticated(user: $user)';
}
...
/// @nodoc
abstract mixin class _$AuthenticatedCopyWith<$Res> implements $AuthenticatorWatcherStateCopyWith<$Res> {
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _IsFirstTime);
}
