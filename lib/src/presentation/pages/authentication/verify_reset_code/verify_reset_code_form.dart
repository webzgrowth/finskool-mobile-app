...
class VerifyResetCodeForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AuthFormListener<PasswordResetBloc, PasswordResetState>(
      status: (s) => s.state,
      message: (s) => s.message,
      isMine: (s) => s.step.isCodeVerified,
      onSuccess: (context, _) => context.push(AppRoutes.NEW_PASSWORD_ROUTE_PATH),
        ...
        return Column(
          ...
          children: [
            ...
            AuthSubmitButton(
              ...
              onPressed: () => bloc.add(const PasswordResetEvent.verifyCode()),
            ),
